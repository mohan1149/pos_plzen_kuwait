...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_in_time":"2000-06-13 13:13:00","clock_in_note":"aut","ip_address":"ullam","latitude":"sequi","longitude":"atque"}'
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_out_time":"2000-06-13 13:13:00","clock_out_note":"adipisci","latitude":"aliquid","longitude":"saepe"}'
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/crm/follow-ups?start_date=2020-12-16&end_date=2020-12-16&status=optio&follow_up_type=officia&followup_category_id=aut&order_by=start_datetime&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
let params = {
    ...
    "end_date": "2020-12-16",
    "status": "optio",
    "follow_up_type": "officia",
    "followup_category_id": "aut",
...
--------- | ------- | ------- | -----------
    ...
    `followup_category_id` |  optional  | filter the result through followup_category_id
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"title":"Meeting with client","contact_id":2,"description":"nihil","schedule_type":"sed","user_id":"[2,3,5]","notify_before":5,"notify_type":"minute","status":"open","notify_via":"['sms' => 0 ,'mail' => 1]","start_datetime":"2021-01-06 13:05:00","end_datetime":"2021-01-06 13:05:00","followup_additional_info":"['call duration' => '1 hour']","allow_notification":true}'
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"title":"Meeting with client","contact_id":2,"description":"amet","schedule_type":"ipsam","user_id":"[2,3,5]","notify_before":5,"notify_type":"minute","status":"open","notify_via":"['sms' => 0 ,'mail' => 1]","followup_additional_info":"['call duration' => '1 hour']","start_datetime":"2021-01-06 13:05:00","end_datetime":"2021-01-06 13:05:00","allow_notification":true}'
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/crm/leads?assigned_to=1%2C2%2C3&name=voluptate&biz_name=odit&mobile_num=16&contact_id=harum&order_by=dignissimos&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"call_logs":[{"mobile_number":"ut","mobile_name":"ducimus","call_type":"call","start_time":"sunt","end_time":"cumque","duration":"labore"}]}'
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":1,"initial_amount":6.81,"created_at":"2020-5-7 15:20:22","closed_at":"2020-5-7 15:20:22","status":"close","closing_amount":132.83,"total_card_slips":9,"total_cheques":7,"closing_note":"provident","transaction_ids":"1,2,3"}'
...
let body = {
    ...
    "status": "close",
    "closing_amount": 132.83,
    "total_card_slips": 9,
    "total_cheques": 7,
    "closing_note": "provident",
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/contactapi?type=delectus&name=aperiam&biz_name=quod&mobile_num=13&contact_id=cum&order_by=atque&direction=sunt&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"nesciunt","prefix":"a","first_name":"fugit","middle_name":"illo","last_name":"fuga","tax_number":"8787fefef","pay_term_number":3,"pay_term_type":"months","mobile":"4578691009","landline":"5487-8454-4145","alternate_number":"841847541222","address_line_1":"repellendus","address_line_2":"iure","city":"et","state":"tempora","country":"aperiam","zip_code":"odit","customer_group_id":"adipisci","contact_id":"fugit","dob":"2000-06-13","custom_field1":"corrupti","custom_field2":"porro","custom_field3":"neque","custom_field4":"sit","email":"eum","shipping_address":"dolorem","position":"reprehenderit","opening_balance":0,"source_id":11,"life_stage_id":19,"assigned_to":[]}'
...
let body = {
    "type": "customer",
    "supplier_business_name": "nesciunt",
    "prefix": "a",
    "first_name": "fugit",
    "middle_name": "illo",
    "last_name": "fuga",
    ...
    "country": "aperiam",
    "zip_code": "odit",
    "customer_group_id": "adipisci",
    "contact_id": "fugit",
    "dob": "2000-06-13",
    "custom_field1": "corrupti",
    "custom_field2": "porro",
    "custom_field3": "neque",
    "custom_field4": "sit",
    "email": "eum",
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"rerum","prefix":"officia","first_name":"et","middle_name":"qui","last_name":"eaque","tax_number":"488744dwd","pay_term_number":3,"pay_term_type":"months","mobile":"8795461009","landline":"65484-848-848","alternate_number":"9898795220","address_line_1":"sequi","address_line_2":"dolorem","city":"omnis","state":"in","country":"et","zip_code":"perferendis","customer_group_id":"rerum","contact_id":"commodi","dob":"2000-06-13","custom_field1":"cum","custom_field2":"amet","custom_field3":"dignissimos","custom_field4":"sed","email":"similique","shipping_address":"eaque","position":"quisquam","opening_balance":10.3,"source_id":4,"life_stage_id":14,"assigned_to":[]}'
...
let body = {
    ...
    "state": "in",
    "country": "et",
    "zip_code": "perferendis",
    "customer_group_id": "rerum",
    "contact_id": "commodi",
    "dob": "2000-06-13",
    "custom_field1": "cum",
    "custom_field2": "amet",
    "custom_field3": "dignissimos",
    "custom_field4": "sed",
    "email": "similique",
    "shipping_address": "eaque",
    "position": "quisquam",
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":17,"amount":453.13,"method":"cash","paid_on":"2020-07-22 15:48:29","account_id":10,"card_number":"aut","card_holder_name":"est","card_transaction_number":"est","card_type":"laborum","card_month":"et","card_year":"nostrum","card_security":"enim","transaction_no_1":"vero","transaction_no_2":"quisquam","transaction_no_3":"dolores","cheque_number":"autem","bank_account_number":"sequi","note":"possimus"}'
...
let body = {
    ...
    "card_year": "nostrum",
    "card_security": "enim",
    "transaction_no_1": "vero",
    "transaction_no_2": "quisquam",
    "transaction_no_3": "dolores",
    "cheque_number": "autem",
    "bank_account_number": "sequi",
    "note": "possimus"
}
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/expense?location_id=1&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=ad&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":1,"final_total":2192.0312065,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":11,"expense_for":13,"contact_id":17,"expense_category_id":7,"expense_sub_category_id":9,"additional_notes":"velit","is_refund":0,"is_recurring":0,"recur_interval":9,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"recusandae","recur_repetitions":10,"payment":[{"amount":453.13,"method":"cash","account_id":8,"card_number":"laudantium","card_holder_name":"ut","card_transaction_number":"maxime","card_type":"accusamus","card_month":"rem","card_year":"ut","card_security":"voluptas","transaction_no_1":"quidem","transaction_no_2":"nisi","transaction_no_3":"perspiciatis","note":"corrupti","cheque_number":"sint"}]}'
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"final_total":241562.364,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":11,"expense_for":7,"contact_id":13,"expense_category_id":10,"expense_sub_category_id":13,"additional_notes":"nisi","is_recurring":0,"recur_interval":18,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"reprehenderit","recur_repetitions":2,"payment":[]}'
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/expense-refund?location_id=1&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=qui&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/field-force?contact_id=exercitationem&assigned_to=ad&status=qui&start_date=2018-06-25&end_date=2018-06-25&per_page=15&order_by_date=desc" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":11,"visit_to":"incidunt","visit_address":"vero","assigned_to":4,"visit_on":"2021-12-28 17:23:00","visit_for":"sit"}'
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"status":"finished","reason_to_not_meet_contact":"labore","visited_on":"2021-12-28 17:23:00","visited_address":"Radhanath Mullick Ln, Tiretta Bazaar, Bow Bazaar, Kolkata, West Bengal, 700 073, India","latitude":"41.40338","longitude":"2.17403","comments":"quo","photo":"sed","meet_with":"enim","meet_with_mobileno":"aut"}'
...
let body = {
    "status": "finished",
    "reason_to_not_meet_contact": "labore",
...
--------- | ------- | ------- | ------- | -----------
    `status` | string |  optional  | Current status of the visit (assigned, finished, met_contact, did_not_meet_contact)
        ...
        `meet_with` | required |  optional  | name of person field force meet with
        `meet_with_mobileno` | required |  optional  | mobile number of the person field force meet with
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/product?order_by=doloremque&order_direction=nam&brand_id=ea&category_id=perferendis&sub_category_id=quos&location_id=1&selling_price_group=corrupti&send_lot_detail=qui&name=tempora&sku=dolores&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/product/1?selling_price_group=accusamus&send_lot_detail=tenetur" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/variation/2?product_id=pariatur&location_id=1&brand_id=repellendus&category_id=rerum&sub_category_id=et&not_for_selling=ipsum&name=quasi&sku=rerum&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
let params = {
    "product_id": "pariatur",
    "location_id": "1",
    "brand_id": "repellendus",
    "category_id": "rerum",
    "sub_category_id": "et",
    "not_for_selling": "ipsum",
    "name": "quasi",
    "sku": "rerum",
    "per_page": "10",
};
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/sell?location_id=1&contact_id=et&status=final&payment_status=due%2Cpartial&start_date=2018-06-25&end_date=2018-06-25&user_id=soluta&res_waiter_id=iusto&shipping_status=ordered&source=explicabo&only_subscriptions=optio&send_purchase_details=et&order_by_date=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
--------- | ------- | ------- | -----------
    ...
    `status` |  optional  | Sell status. Available values final, draft, quotation, proforma
    ...
    `res_waiter_id` |  optional  | id of the service staff assigned with the sale
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"sells":[{"location_id":1,"contact_id":20,"transaction_date":"2020-07-22 15:48:29","invoice_no":"pariatur","source":"api, phone, woocommerce","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":6,"discount_amount":10,"discount_type":"fixed","sale_note":"nobis","staff_note":"ipsam","commission_agent":1,"shipping_details":"Express Delivery","shipping_address":"unde","shipping_status":"ordered","delivered_to":"'Mr robin'","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":18,"pay_term_number":3,"pay_term_type":"months","is_suspend":false,"is_recurring":0,"recur_interval":18,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"est","recur_repetitions":3,"rp_redeemed":17,"rp_redeemed_amount":13.5,"types_of_service_id":17,"service_custom_field_1":"voluptatem","service_custom_field_2":"dolorem","service_custom_field_3":"cumque","service_custom_field_4":"est","service_custom_field_5":"ut","service_custom_field_6":"fuga","round_off_amount":352800.545213619,"table_id":6,"res_waiter_id":12,"change_return":0,"products":[{"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":0,"discount_amount":0,"discount_type":"percentage","sub_unit_id":15,"note":"qui"}],"payments":[{"amount":453.13,"method":"cash","account_id":3,"card_number":"pariatur","card_holder_name":"incidunt","card_transaction_number":"sed","card_type":"facere","card_month":"excepturi","card_year":"velit","card_security":"rerum","transaction_no_1":"vero","transaction_no_2":"earum","transaction_no_3":"ipsam","bank_account_number":"id","note":"animi","cheque_number":"adipisci"}]}]}'
    ...
    "sells": [
        {
            ...
            "service_custom_field_1": "voluptatem",
            "service_custom_field_2": "dolorem",
            "service_custom_field_3": "cumque",
            "service_custom_field_4": "est",
            "service_custom_field_5": "ut",
            "service_custom_field_6": "fuga",
            "round_off_amount": 352800.545213619,
            "table_id": 6,
            "res_waiter_id": 12,
            "change_return": 0,
            "products": [
...
--------- | ------- | ------- | ------- | -----------
    `sells.*.location_id` | integer |  required  | id of the business location
        ...
        `sells.*.res_waiter_id` | integer |  optional  | id of the service staff assigned to the sale
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/sell/55?send_purchase_details=eveniet" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":17,"transaction_date":"2020-5-7 15:20:22","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":16,"discount_amount":10,"discount_type":"fixed","sale_note":"deserunt","source":"non","staff_note":"atque","is_suspend":false,"commission_agent":7,"shipping_details":"Express Delivery","shipping_address":"hic","shipping_status":"ordered","delivered_to":"Mr Robin","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":11,"pay_term_number":3,"pay_term_type":"months","is_recurring":0,"recur_interval":2,"recur_interval_type":"days","subscription_repeat_on":7,"subscription_no":"dicta","recur_repetitions":7,"rp_redeemed":1,"rp_redeemed_amount":13.5,"types_of_service_id":1,"service_custom_field_1":"illum","service_custom_field_2":"quam","service_custom_field_3":"inventore","service_custom_field_4":"voluptates","service_custom_field_5":"et","service_custom_field_6":"ratione","round_off_amount":0,"table_id":4,"res_waiter_id":12,"change_return":0,"change_return_id":11,"products":[{"sell_line_id":16,"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":13,"discount_amount":0,"discount_type":"percentage","sub_unit_id":20,"note":"ut"}],"payments":[{"payment_id":13,"amount":453.13,"method":"cash","account_id":11,"card_number":"tempora","card_holder_name":"neque","card_transaction_number":"ut","card_type":"neque","card_month":"recusandae","card_year":"doloribus","card_security":"et","transaction_no_1":"eos","transaction_no_2":"quia","transaction_no_3":"velit","note":"quis","cheque_number":"dolorem","bank_account_number":"deserunt"}]}'
...
let body = {
    ...
    "subscription_no": "dicta",
    "recur_repetitions": 7,
    "rp_redeemed": 1,
    "rp_redeemed_amount": 13.5,
    "types_of_service_id": 1,
    "service_custom_field_1": "illum",
    "service_custom_field_2": "quam",
    "service_custom_field_3": "inventore",
    "service_custom_field_4": "voluptates",
    "service_custom_field_5": "et",
    "service_custom_field_6": "ratione",
    "round_off_amount": 0,
    "table_id": 4,
    "res_waiter_id": 12,
    "change_return": 0,
...
--------- | ------- | ------- | ------- | -----------
    `contact_id` | integer |  optional  | id of the customer
        ...
        `res_waiter_id` | integer |  optional  | id of the service staff assigned to the sale
...
```bash
curl -X DELETE \
    "http://localhost/connector/api/sell/impedit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"transaction_id":6,"transaction_date":"2020-5-7 15:20:22","invoice_no":"temporibus","discount_amount":10,"discount_type":"fixed","products":[{"sell_line_id":6,"quantity":1,"unit_price_inc_tax":437.5}]}'
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"id":12,"shipping_status":"ordered","delivered_to":"sit"}'
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/taxonomy?type=enim" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"surname":"impedit","first_name":"ex","last_name":"eum","email":"a","is_active":"ut","user_type":"repudiandae","crm_contact_id":3,"allow_login":false,"username":"est","password":"non","role":13,"access_all_locations":false,"location_permissions":[],"cmmsn_percent":"alias","max_sales_discount_percent":"ullam","selected_contacts":true,"selected_contact_ids":[],"dob":"voluptatibus","gender":"officiis","marital_status":"magni","blood_group":"cum","contact_number":"fugit","alt_number":"quos","family_number":"dolores","fb_link":"quisquam","twitter_link":"id","social_media_1":"commodi","social_media_2":"unde","custom_field_1":"perferendis","custom_field_2":"qui","custom_field_3":"enim","custom_field_4":"fugit","guardian_name":"perferendis","id_proof_name":"quaerat","id_proof_number":"laudantium","permanent_address":"delectus","current_address":"suscipit","bank_details":[{"account_holder_name":"dolor","account_number":"consectetur","bank_name":"totam","bank_code":"porro","branch":"delectus","tax_payer_id":"voluptatem"}]}'
...
let body = {
    ...
    "dob": "voluptatibus",
    "gender": "officiis",
    "marital_status": "magni",
    "blood_group": "cum",
    "contact_number": "fugit",
    "alt_number": "quos",
    "family_number": "dolores",
    "fb_link": "quisquam",
    "twitter_link": "id",
    "social_media_1": "commodi",
    "social_media_2": "unde",
    "custom_field_1": "perferendis",
    "custom_field_2": "qui",
    "custom_field_3": "enim",
    "custom_field_4": "fugit",
    "guardian_name": "perferendis",
    "id_proof_name": "quaerat",
    "id_proof_number": "laudantium",
    "permanent_address": "delectus",
    "current_address": "suscipit",
    "bank_details": [
        {
            "account_holder_name": "dolor",
            "account_number": "consectetur",
            "bank_name": "totam",
            "bank_code": "porro",
            "branch": "delectus",
            "tax_payer_id": "voluptatem"
        }
    ]
}
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/user?service_staff=voluptas" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"current_password":"molestias","new_password":"et"}'
