...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_in_time":"2000-06-13 13:13:00","clock_in_note":"autem","ip_address":"recusandae","latitude":"eos","longitude":"provident"}'
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_out_time":"2000-06-13 13:13:00","clock_out_note":"porro","latitude":"dolor","longitude":"ut"}'
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/crm/follow-ups?start_date=2020-12-16&end_date=2020-12-16&status=quae&follow_up_type=vel&followup_category_id=magnam&order_by=start_datetime&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/crm/leads?assigned_to=1%2C2%2C3&name=accusantium&biz_name=soluta&mobile_num=1&contact_id=id&order_by=corrupti&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"call_logs":[{"mobile_number":"ratione","mobile_name":"ut","call_type":"call","start_time":"odit","end_time":"occaecati","duration":"cum"}]}'
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":1,"initial_amount":2090869.3849852527,"created_at":"2020-5-7 15:20:22","closed_at":"2020-5-7 15:20:22","status":"close","closing_amount":1.191447,"total_card_slips":8,"total_cheques":10,"closing_note":"vel","transaction_ids":"1,2,3"}'
...
let body = {
    "location_id": 1,
    "initial_amount": 2090869.3849852527,
    "created_at": "2020-5-7 15:20:22",
    "closed_at": "2020-5-7 15:20:22",
    "status": "close",
    "closing_amount": 1.191447,
    "total_card_slips": 8,
    "total_cheques": 10,
    "closing_note": "vel",
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/contactapi?type=doloribus&name=et&biz_name=aut&mobile_num=8&contact_id=voluptas&order_by=fuga&direction=cum&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"iure","prefix":"corrupti","first_name":"quia","middle_name":"ea","last_name":"qui","tax_number":"8787fefef","pay_term_number":3,"pay_term_type":"months","mobile":"4578691009","landline":"5487-8454-4145","alternate_number":"841847541222","address_line_1":"quaerat","address_line_2":"commodi","city":"vel","state":"sint","country":"animi","zip_code":"voluptas","customer_group_id":"aut","contact_id":"temporibus","dob":"2000-06-13","custom_field1":"nulla","custom_field2":"enim","custom_field3":"adipisci","custom_field4":"dignissimos","email":"aut","shipping_address":"reprehenderit","position":"sed","opening_balance":0,"source_id":18,"life_stage_id":1,"assigned_to":[]}'
...
let body = {
    ...
    "custom_field1": "nulla",
    "custom_field2": "enim",
    "custom_field3": "adipisci",
    "custom_field4": "dignissimos",
    "email": "aut",
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"eos","prefix":"iusto","first_name":"et","middle_name":"sit","last_name":"debitis","tax_number":"488744dwd","pay_term_number":3,"pay_term_type":"months","mobile":"8795461009","landline":"65484-848-848","alternate_number":"9898795220","address_line_1":"deserunt","address_line_2":"nulla","city":"quos","state":"distinctio","country":"qui","zip_code":"modi","customer_group_id":"perferendis","contact_id":"vitae","dob":"2000-06-13","custom_field1":"quia","custom_field2":"reiciendis","custom_field3":"sequi","custom_field4":"laborum","email":"voluptatem","shipping_address":"et","position":"quibusdam","opening_balance":10.3,"source_id":7,"life_stage_id":7,"assigned_to":[]}'
...
let body = {
    ...
    "country": "qui",
    "zip_code": "modi",
    "customer_group_id": "perferendis",
    "contact_id": "vitae",
    "dob": "2000-06-13",
    "custom_field1": "quia",
    "custom_field2": "reiciendis",
    "custom_field3": "sequi",
    "custom_field4": "laborum",
    "email": "voluptatem",
    "shipping_address": "et",
    "position": "quibusdam",
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":17,"amount":453.13,"method":"cash","paid_on":"2020-07-22 15:48:29","account_id":11,"card_number":"quis","card_holder_name":"molestias","card_transaction_number":"voluptates","card_type":"laborum","card_month":"ipsa","card_year":"ab","card_security":"et","transaction_no_1":"sapiente","transaction_no_2":"rerum","transaction_no_3":"sunt","cheque_number":"perferendis","bank_account_number":"ipsa","note":"sequi"}'
...
let body = {
    ...
    "card_transaction_number": "voluptates",
    "card_type": "laborum",
    "card_month": "ipsa",
    "card_year": "ab",
    "card_security": "et",
    ...
    "transaction_no_3": "sunt",
    "cheque_number": "perferendis",
    "bank_account_number": "ipsa",
    "note": "sequi"
}
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/expense?location_id=1&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=labore&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":1,"final_total":5408136.8540529,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":12,"expense_for":3,"contact_id":3,"expense_category_id":5,"expense_sub_category_id":7,"additional_notes":"vel","is_refund":0,"is_recurring":0,"recur_interval":16,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"consequatur","recur_repetitions":16,"payment":[{"amount":453.13,"method":"cash","account_id":7,"card_number":"sunt","card_holder_name":"assumenda","card_transaction_number":"voluptate","card_type":"ut","card_month":"provident","card_year":"adipisci","card_security":"qui","transaction_no_1":"autem","transaction_no_2":"molestiae","transaction_no_3":"fugiat","note":"enim","cheque_number":"enim"}]}'
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"final_total":0,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":18,"expense_for":14,"contact_id":8,"expense_category_id":19,"expense_sub_category_id":7,"additional_notes":"similique","is_recurring":0,"recur_interval":15,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"tenetur","recur_repetitions":9,"payment":[]}'
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/expense-refund?location_id=1&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=vitae&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/field-force?contact_id=magnam&assigned_to=repellendus&status=eius&start_date=2018-06-25&end_date=2018-06-25&per_page=15&order_by_date=desc" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":14,"visit_to":"qui","visit_address":"odio","assigned_to":19,"visit_on":"2021-12-28 17:23:00","visit_for":"nam"}'
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"status":"finished","reason_to_not_meet_contact":"quia","visited_on":"2021-12-28 17:23:00","visited_address":"Radhanath Mullick Ln, Tiretta Bazaar, Bow Bazaar, Kolkata, West Bengal, 700 073, India","latitude":"41.40338","longitude":"2.17403","comments":"blanditiis","photo":"delectus","meet_with":"tenetur","meet_with_mobileno":"et"}'
...
let body = {
    "status": "finished",
    "reason_to_not_meet_contact": "quia",
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/product?order_by=corrupti&order_direction=in&brand_id=nemo&category_id=eos&sub_category_id=dolorem&location_id=1&selling_price_group=culpa&send_lot_detail=et&name=ea&sku=non&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/product/1?selling_price_group=consequatur&send_lot_detail=omnis" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
let params = {
    "selling_price_group": "consequatur",
    "send_lot_detail": "omnis",
};
Object.keys(params)
    .forEach(key => url.searchParams.append(key, params[key]));
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/variation/2?product_id=nesciunt&location_id=1&brand_id=dolorem&category_id=dolorem&sub_category_id=repellendus&not_for_selling=provident&name=fugit&sku=rem&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/sell?location_id=1&contact_id=porro&status=final&payment_status=due%2Cpartial&start_date=2018-06-25&end_date=2018-06-25&user_id=omnis&res_waiter_id=ipsa&shipping_status=ordered&source=qui&only_subscriptions=et&send_purchase_details=aut&order_by_date=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"sells":[{"location_id":1,"contact_id":6,"transaction_date":"2020-07-22 15:48:29","invoice_no":"aliquam","source":"api, phone, woocommerce","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":7,"discount_amount":10,"discount_type":"fixed","sale_note":"aperiam","staff_note":"corrupti","commission_agent":1,"shipping_details":"Express Delivery","shipping_address":"reiciendis","shipping_status":"ordered","delivered_to":"'Mr robin'","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":12,"pay_term_number":3,"pay_term_type":"months","is_suspend":false,"is_recurring":0,"recur_interval":20,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"veniam","recur_repetitions":3,"rp_redeemed":15,"rp_redeemed_amount":13.5,"types_of_service_id":16,"service_custom_field_1":"dolorum","service_custom_field_2":"laboriosam","service_custom_field_3":"officiis","service_custom_field_4":"earum","service_custom_field_5":"sit","service_custom_field_6":"cumque","round_off_amount":1.8293104,"table_id":5,"res_waiter_id":6,"change_return":0,"products":[{"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":0,"discount_amount":0,"discount_type":"percentage","sub_unit_id":10,"note":"natus"}],"payments":[{"amount":453.13,"method":"cash","account_id":10,"card_number":"consectetur","card_holder_name":"assumenda","card_transaction_number":"eius","card_type":"voluptatem","card_month":"dolores","card_year":"veritatis","card_security":"ex","transaction_no_1":"et","transaction_no_2":"nulla","transaction_no_3":"aspernatur","bank_account_number":"fugit","note":"inventore","cheque_number":"rerum"}]}]}'
    ...
    "sells": [
        {
            ...
            "recur_interval_type": "months",
            "subscription_repeat_on": 15,
            "subscription_no": "veniam",
            "recur_repetitions": 3,
            "rp_redeemed": 15,
            "rp_redeemed_amount": 13.5,
            "types_of_service_id": 16,
            "service_custom_field_1": "dolorum",
            "service_custom_field_2": "laboriosam",
            "service_custom_field_3": "officiis",
            "service_custom_field_4": "earum",
            "service_custom_field_5": "sit",
            "service_custom_field_6": "cumque",
            "round_off_amount": 1.8293104,
            "table_id": 5,
            "res_waiter_id": 6,
            "change_return": 0,
            "products": [
            ...
            "payments": [
                {
                    ...
                    "card_security": "ex",
                    "transaction_no_1": "et",
                    "transaction_no_2": "nulla",
                    "transaction_no_3": "aspernatur",
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/sell/55?send_purchase_details=rem" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":19,"transaction_date":"2020-5-7 15:20:22","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":8,"discount_amount":10,"discount_type":"fixed","sale_note":"nam","source":"itaque","staff_note":"perspiciatis","is_suspend":false,"commission_agent":13,"shipping_details":"Express Delivery","shipping_address":"velit","shipping_status":"ordered","delivered_to":"Mr Robin","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":12,"pay_term_number":17,"pay_term_type":"months","is_recurring":0,"recur_interval":3,"recur_interval_type":"days","subscription_repeat_on":7,"subscription_no":"recusandae","recur_repetitions":13,"rp_redeemed":3,"rp_redeemed_amount":13.5,"types_of_service_id":18,"service_custom_field_1":"et","service_custom_field_2":"rerum","service_custom_field_3":"id","service_custom_field_4":"qui","service_custom_field_5":"illo","service_custom_field_6":"perspiciatis","round_off_amount":10911100.788903523,"table_id":17,"res_waiter_id":13,"change_return":0,"change_return_id":8,"products":[{"sell_line_id":17,"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":7,"discount_amount":0,"discount_type":"percentage","sub_unit_id":11,"note":"qui"}],"payments":[{"payment_id":19,"amount":453.13,"method":"cash","account_id":11,"card_number":"soluta","card_holder_name":"et","card_transaction_number":"architecto","card_type":"id","card_month":"reprehenderit","card_year":"sed","card_security":"non","transaction_no_1":"tempora","transaction_no_2":"ipsa","transaction_no_3":"vitae","note":"molestiae","cheque_number":"eos","bank_account_number":"hic"}]}'
...
let body = {
    ...
    "service_custom_field_2": "rerum",
    "service_custom_field_3": "id",
    "service_custom_field_4": "qui",
    "service_custom_field_5": "illo",
    "service_custom_field_6": "perspiciatis",
    "round_off_amount": 10911100.788903523,
    "table_id": 17,
    "res_waiter_id": 13,
    "change_return": 0,
    "change_return_id": 8,
    ...
    "payments": [
        {
            ...
            "card_type": "id",
            "card_month": "reprehenderit",
            "card_year": "sed",
            "card_security": "non",
            "transaction_no_1": "tempora",
            "transaction_no_2": "ipsa",
            "transaction_no_3": "vitae",
            "note": "molestiae",
            "cheque_number": "eos",
            "bank_account_number": "hic"
        }
    ]
}
...
```bash
curl -X DELETE \
    "http://localhost/connector/api/sell/fugit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"transaction_id":5,"transaction_date":"2020-5-7 15:20:22","invoice_no":"sed","discount_amount":10,"discount_type":"fixed","products":[{"sell_line_id":7,"quantity":1,"unit_price_inc_tax":437.5}]}'
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"id":6,"shipping_status":"ordered","delivered_to":"dolorum"}'
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/taxonomy?type=quos" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"surname":"quo","first_name":"omnis","last_name":"debitis","email":"illo","is_active":"sint","user_type":"blanditiis","crm_contact_id":11,"allow_login":true,"username":"aut","password":"earum","role":17,"access_all_locations":true,"location_permissions":[],"cmmsn_percent":"perspiciatis","max_sales_discount_percent":"tempore","selected_contacts":false,"selected_contact_ids":[],"dob":"qui","gender":"eum","marital_status":"dolore","blood_group":"quaerat","contact_number":"consequuntur","alt_number":"mollitia","family_number":"quidem","fb_link":"et","twitter_link":"id","social_media_1":"eius","social_media_2":"aut","custom_field_1":"odit","custom_field_2":"qui","custom_field_3":"qui","custom_field_4":"totam","guardian_name":"suscipit","id_proof_name":"laboriosam","id_proof_number":"est","permanent_address":"tempora","current_address":"porro","bank_details":[{"account_holder_name":"in","account_number":"modi","bank_name":"possimus","bank_code":"optio","branch":"dolor","tax_payer_id":"laborum"}]}'
...
let body = {
    ...
    "cmmsn_percent": "perspiciatis",
    "max_sales_discount_percent": "tempore",
    "selected_contacts": false,
    "selected_contact_ids": [],
    "dob": "qui",
    "gender": "eum",
    "marital_status": "dolore",
    "blood_group": "quaerat",
    "contact_number": "consequuntur",
    "alt_number": "mollitia",
    "family_number": "quidem",
    "fb_link": "et",
    "twitter_link": "id",
    "social_media_1": "eius",
    "social_media_2": "aut",
    ...
    "guardian_name": "suscipit",
    "id_proof_name": "laboriosam",
    "id_proof_number": "est",
    "permanent_address": "tempora",
    "current_address": "porro",
    "bank_details": [
        {
            "account_holder_name": "in",
            "account_number": "modi",
            "bank_name": "possimus",
            "bank_code": "optio",
            "branch": "dolor",
            "tax_payer_id": "laborum"
        }
    ]
}
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/user?service_staff=architecto" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"current_password":"sed","new_password":"voluptatibus"}'
